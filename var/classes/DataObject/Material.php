...
* @method static \Pimcore\Model\DataObject\Material\Listing|\Pimcore\Model\DataObject\Material getByCoating ($value, $limit = 0, $offset = 0) 
*/
...
public function getCoating () {
	if($this instanceof PreGetValueHookInterface && !\Pimcore::inAdmin()) { 
		$preValue = $this->preGetValue("coating"); 
		if($preValue !== null) { 
			return $preValue;
		}
	} 
...
/**
* Set coating - Coating
* @param bool|null $coating
* @return \Pimcore\Model\DataObject\Material
*/
public function setCoating ($coating) {
	$fd = $this->getClass()->getFieldDefinition("coating");
